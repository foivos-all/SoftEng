...
public class PatientNearbyHospitals extends AppCompatActivity implements OnMapReadyCallback {
    boolean isPermissionGranted;
    GoogleMap mGoogleMap;
    SupportMapFragment supportMapFragment;
    private static final String BASE_URL= "http://10.0.2.2/getNearbyHospitals.php";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_patient_nearby_hospitals);

        checkMyPermission();

        if (isPermissionGranted){
            supportMapFragment = (SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.nearby_hospitals_map);
